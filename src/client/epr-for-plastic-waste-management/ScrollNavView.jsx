    ...
    <div className="sticky top-0 z-50 bg-white">
      ...
      >
        ...
        <h3 className="text-xl md:text-2xl font-semibold mb-6">
          ...
          <p><strong>Category I:</strong> Packaging made of rigid plastic</p>
          <p><strong>Category II:</strong>Carry bags, plastic sachets, or pouches, single-layer or multilayer flexible plastic packaging which is more than one
layer with various types of plastic, plastic sheets, or similar covers made of plastic sheets</p>
          <p><strong>Category III:</strong> Conatainer made of plastic layers at least one layer of plasic and at least one layer of material other than plastic.</p>
          <p>Category IV: Plastic sheet used for packaging as well as compostable plastic carry bags</p>
